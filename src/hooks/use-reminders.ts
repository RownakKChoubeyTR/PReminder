...
async function checkCooldowns(recipients: string[], prNumber: number, repo: string): Promise<CooldownResponse> {
    const params = new URLSearchParams({
...
export function useCooldownCheck(recipients: string[], prNumber: number | null, repo: string | null) {
    return useQuery({
