        ...
        <div className={styles.page}>
            <div className={styles.pageHeader}>
                ...
                <p className={styles.pageDescription}>
                    Create and customize reminder templates for Teams, email, and channel messages. Use variables like{' '}
                    <code>{'{receiverName}'}</code> and <code>{'{prTitle}'}</code> for dynamic content.
                </p>
            </div>
                    ...
                    {showForm ? (
                        <div className={styles.editorLayout}>
                            ...
                            <div className={styles.previewPanel}>
                                <TemplatePreview body={liveBody} subject={liveSubject || undefined} type={liveType} />
                            </div>
                        </div>
                    ) : (
