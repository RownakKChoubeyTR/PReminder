...
export async function GET() {
    ...
    try {
        ...
        const res = await fetch(`https://api.github.com/orgs/${orgEncoded}/repos?type=all&sort=updated&per_page=5`, {
            headers: {
    ...
    try {
        ...
        const res = await fetch(`https://api.github.com/search/repositories?q=${q}&sort=updated&per_page=5`, {
            headers: {
                Authorization: `Bearer ${token}`,
                Accept: 'application/vnd.github+json',
                'X-GitHub-Api-Version': '2022-11-28'
