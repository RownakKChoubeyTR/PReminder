...
export async function GET() {
    ...
    try {
        ...
        return NextResponse.json({ error: 'Failed to fetch templates', code: 'INTERNAL_ERROR' }, { status: 500 });
    }
}
...
export async function POST(request: Request) {
    ...
    try {
        ...
        return NextResponse.json({ error: 'Failed to create template', code: 'INTERNAL_ERROR' }, { status: 500 });
    }
}
