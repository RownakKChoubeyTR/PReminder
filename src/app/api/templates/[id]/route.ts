...
export async function GET(_request: Request, { params }: RouteParams) {
    ...
    try {
        ...
        return NextResponse.json({ error: 'Failed to fetch template', code: 'INTERNAL_ERROR' }, { status: 500 });
    }
}
...
export async function PUT(request: Request, { params }: RouteParams) {
    ...
    try {
        ...
        return NextResponse.json({ error: 'Failed to update template', code: 'INTERNAL_ERROR' }, { status: 500 });
    }
}
...
export async function DELETE(_request: Request, { params }: RouteParams) {
    ...
    try {
        ...
        return NextResponse.json({ error: 'Failed to delete template', code: 'INTERNAL_ERROR' }, { status: 500 });
    }
}
